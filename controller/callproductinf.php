...
$sql3 = "SELECT * FROM `recommend` WHERE `rc_account`= '$user_account' AND `rc_product_id` = '$getpid' ";
$data3 = mysqli_query($link,$sql3);
$sql4 = "SELECT COUNT(rc_account) FROM `recommend` WHERE `rc_product_id` = '$getpid'";
